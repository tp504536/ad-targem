...
class MainWindow:
    ...
    def setup_create_tab(self):
        ...
        tk.Checkbutton(opts_frame, text="Добавить в Wiki (запросит учетные данные админа)",
                       variable=self.chk_wiki).grid(row=0, column=0, sticky="w", padx=10)
    ...
    def create_user_action(self):
        ...
        success = user_operations.create_user(
            ...
            self.root,  # Передаем родительское окно
            self.log
        )
